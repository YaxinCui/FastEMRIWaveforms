...
cdef extern from "interpolate.hh":
    ...
    # except + converts C++ exceptions (e.g. the cuSPARSE status errors thrown
    # by fit_wrap) into Python RuntimeError instead of std::terminate.
    void interpolate_arrays(double *t_arr, double *interp_array, int ninterps, int length, double *B, double *upper_diag, double *diag, double *lower_diag) except +
    ...
    void get_waveform(cmplx *d_waveform, double *interp_array, double *phase_interp_t, double *phase_interp_coeffs,
                  ...
                  double delta_t, double *h_t, int dev) except +
    ...
    void get_waveform_generic_fd(cmplx *waveform,
             double *interp_array, double *phase_interp_t, double *phase_interp_coeffs,
              ...
              bool include_minus_m, bool separate_modes) except +
